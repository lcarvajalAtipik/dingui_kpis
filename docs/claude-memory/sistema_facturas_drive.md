...
metadata: 
  ...
  modified: 2026-08-27T09:49:39.162Z
---
...
**⚠ LECCIÓN reconciliación 27/08:** a Drive suben archivos VARIAS manos (equipo desde el móvil, otras sesiones desde email_inbox, el usuario) SIN registrar y con nombres distintos para el mismo doc (se encontraron hasta 3 copias de una factura, y facturas de julio en la carpeta de agosto). Regla: **el diff fiable es Drive↔registro por drive_id** (inventario MCP por parentId), nunca por nombre; antes de subir nada, comprobar si ya existe con otro nombre. El 27/08 se reconciliaron 82 huérfanos: 45 registrados (30 del email + Makro×7, Stipendium 1ª factura 2026/1033 jun 242€, Lorente fact 28, Bazar Vinador "Mantel chino", albaranes, DJ Lanero), 38 duplicados borrados de Drive, email_registro a CERO pendientes. Registros nuevos con n_lineas_fb=0 → **líneas F&B de jun-ago PENDIENTES de extraer** (Merino/Melgarejo/CCEP/Picking/La Encina/Ipasur agosto).
