...
**⚠ Incoherencia a corregir en el artifact:** otra sesión (commits bfc11c7 y d60b25a, 17/09) dejó el coste del proyecto en **501.255,86 €** (preapertura operativa, Tipsi y gastos extra de apertura fuera del total, ver docs/coste_proyecto_apertura.md). El artifact v8 aún dice 532.415,12 en la fila memo «Inversión del proyecto» (FILAS_PL) y en el aviso del P&L → actualizar texto en la próxima publicación.
