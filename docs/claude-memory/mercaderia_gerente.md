...
**Hielo (RESUELTO 07/08):** Hielo Express Los Mellis factura semanal (facturas simplificadas): nº1353 13/07 base 473,64 + nº1430 20/07 base 932,81 + nº1572 02/08 base 1.362,90 (total 1.531,00 = transferencia Caixa 04/08 exacta; ~74% hielo al 10%, resto Coca-Cola/agua al 21%). El usuario CONFIRMÓ (07/08) que la 1572 cubre el finde 31/7–2/8 → prorrateo por noches (1 de 3 = noche 31/7 es julio): 454,30 base a julio. **Hielo julio total = 1.406,45 + 454,30 = 1.860,75 base** (COGS julio definitivo = 34.608 − 1.574 hielo provisional + 1.860,75 hielo documentado = **34.895**, 17,2% s/ingresos). El prorrateo 1/3 es criterio mío declarado, ajustable. Se paga por TRANSFERENCIA, no en efectivo.
