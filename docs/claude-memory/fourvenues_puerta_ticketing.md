...
**RESUELTO 17/09/2026 — FV CUADRA SIN RETIRADAS:** el +13.946,03 del 21/08 NO fue retirada de FV sino la 2ª devolución de IVA de preapertura (cuadra al céntimo con la cuenta 470). Y no hace falta: FV vendido según cierres = jul 42.525,08 + ago 39.750,22 (hasta el 26) + noches 27–28 ≈ **83.700 = saldo visto el 28/08**. El "~97K" de antes incluía un junio de 8,5K hipotético (doble conteo con la preventa de julio) y agosto proyectado. Modelo v4: FV_REAL jun 0 / jul 42.525 / ago 83.700; ventas FV caja ago 41.175. **Aún CERO retiradas de FV a banco.**
