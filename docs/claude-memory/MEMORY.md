...
- [Bank ingest state](project_bank_ingest_state.md) — SQLite local con 489 movs hasta 05/08/2026; 1 sin categorizar (Discount_ES −747,89). OJO: export Santander 05/08 incompleto (−22,4K del 4-5/8 sin filas), pedir re-export.
...
- [Ledger obra/proveedores](obra_proveedores_ledger.md) — Lorente: Cert 06 facturada 07/08 (fact 28 = 23.699,33, +56,90 vs doc oficial → aclarar antes de pagar); Sánchez Yuste y Stima CERRADAS; Aycoa YA FACTURÓ 10/08 (44.114,18, +2.831 vs resumen jun → preguntar) pdte 24.114,18; BS Aislamientos 12.653 o cierre negociado. Préstamo socios 12K in / 8K devuelto / 4K vivo.
